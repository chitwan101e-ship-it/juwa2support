...
const downloadGuideLinkClass =
  'font-semibold text-[#f5d040] underline decoration-[#f5d040]/50 underline-offset-2 hover:text-[#b8a6ff]'
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#000000]">
        <Loader2 className="h-8 w-8 animate-spin text-[#f5d040]" />
      </div>
    )
  }

  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top_left,_#0f1840_0%,_#070a18_45%,_#000000_100%)] text-[14px] leading-snug text-white">
      <header className="flex items-center gap-2 border-b border-white/[0.08] bg-[#0c0c0c]/40 px-4 pb-2 pt-3 backdrop-blur-sm">
        <button
          type="button"
      ...
      <main className="mx-auto max-w-lg px-4 pb-28 pt-5">
        ...
        <div className="mt-3 rounded-2xl border border-[#f5d040]/25 bg-[#f5d040]/10 p-4">
          <h2 className="text-[15px] font-bold text-white">FREE Play promo</h2>
          <p className="mt-2 text-[13px] leading-relaxed text-[#c4cbe6]">
            Announced every <span className="font-semibold text-white">Thursday</span> on JUWA2 Support — check your feed and
        ...
        <p className="mt-5 text-[12px] leading-relaxed text-[#7f8bad] border-l-2 border-[#f5d040]/35 pl-3.5">
          JUWA2 Support may suspend or restrict accounts that break these program rules, abuse the platform, or put other
          members at risk. We exercise this only when we believe it is necessary to keep JUWA2 Support fair and safe for
          everyone.
        </p>
        <div className="mt-5 space-y-3 rounded-2xl border border-white/[0.08] bg-[rgba(11,18,40,0.9)] p-4 text-[13px] leading-relaxed text-[#8892b0]">
          ...
          <p>
            For more information, open <span className="font-semibold text-[#f5d040]">Chat</span> from the bar below

...
export default function UpdatePasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="flex justify-center mb-8">
          <Juwa2Logo theme="dark" size="md" />
        </div>
        ...
        <form onSubmit={(e) => void onSubmit(e)} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-xl bg-[#d4af37] hover:bg-[#6d4ee6] font-semibold text-white disabled:opacity-50 flex items-center justify-center gap-2"
          >
        ...
        <p className="text-center mt-8 text-sm text-[#7f8bad]">
          <Link href="/login" className="text-[#f5d040] hover:underline">
            Back to sign in
          </Link>
        </p>
      </div>
